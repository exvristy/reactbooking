...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
    ...
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L2, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D2, onError: U2, queryStringArrayFormat: F, cancelToken: new AbortController() }, g({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
...
var E = N2;
function L({ children: l, initialPage: c, initialComponent: a, resolveComponent: p, titleCallback: s, onHeadUpdate: S2 }) {
  let [d, P] = (0, import_react2.useState)({ component: a || null, page: c, key: null }), u2 = (0, import_react2.useMemo)(() => Q(typeof window > "u", s || ((f2) => f2), S2 || (() => {
  })), []);
...
L.displayName = "Inertia";
async function U({ id: l = "app", resolve: c, setup: a, title: p, progress: s = {}, page: S2, render: d }) {
  let P = typeof window > "u", u2 = P ? null : document.getElementById(l), g = S2 || JSON.parse(u2.dataset.page), f2 = (r) => Promise.resolve(c(r)).then((y) => y.default || y), e = [], i = await f2(g.component).then((r) => a({ el: u2, App: L, props: { initialPage: g, initialComponent: r, resolveComponent: f2, titleCallback: p, onHeadUpdate: P ? (y) => e = y : null } }));
  if (!P && s && Z(s), P) {
    let r = await d((0, import_react.createElement)("div", { id: l, "data-page": JSON.stringify(g) }, i));
    return { head: e, body: r };
  }
}
var oe2 = function({ children: l, title: c }) {
  let a = (0, import_react5.useContext)(A2), p = (0, import_react5.useMemo)(() => a.createProvider(), [a]);
  ...
  function P(e) {
    let i = S2(e);
    return e.props.children && (i += d(e)), e.props.dangerouslySetInnerHTML && (i += e.props.dangerouslySetInnerHTML.__html), s(e) || (i += `</${e.type}>`), i;
  }
  function u2(e) {
...
var le = (0, import_react6.forwardRef)(({ children: l, as: c = "a", data: a = {}, href: p, method: s = "get", preserveScroll: S2 = false, preserveState: d = null, replace: P = false, only: u2 = [], headers: g = {}, queryStringArrayFormat: f2 = "brackets", onClick: e = k2, onCancelToken: i = k2, onBefore: r = k2, onStart: y = k2, onProgress: T = k2, onFinish: H2 = k2, onCancel: F = k2, onSuccess: M2 = k2, onError: b = k2, ...O2 }, x) => {
  let I2 = (0, import_react6.useCallback)((o) => {
    e(o), ee(o) && (o.preventDefault(), Oe.visit(p, { data: a, method: s, preserveScroll: S2, preserveState: d ?? s !== "get", replace: P, only: u2, headers: g, onCancelToken: i, onBefore: r, onStart: y, onProgress: T, onFinish: H2, onCancel: F, onSuccess: M2, onError: b }));
  }, [a, p, s, S2, d, P, u2, g, e, i, r, y, T, H2, F, M2, b]);
  c = c.toLowerCase(), s = s.toLowerCase();
  let [h, t] = k(s, p || "", a, f2);
  return p = h, a = t, c === "a" && s !== "get" && console.warn(`Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.

Please specify a more appropriate element using the "as" attribute. For example:

<Link href="${p}" method="${s}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...O2, ...c === "a" ? { href: p } : {}, ref: x, onClick: I2 }, l);
});
var de = le;
function w2(l, c) {
  let [a, p] = (0, import_react8.useState)(() => {
    let s = Oe.restore(c);
    return s !== void 0 ? s : l;
  });
...
function _2(l, c) {
  let a = (0, import_react7.useRef)(null), p = typeof l == "string" ? l : null, [s, S2] = (0, import_react7.useState)((typeof l == "string" ? c : l) || {}), d = (0, import_react7.useRef)(null), P = (0, import_react7.useRef)(null), [u2, g] = p ? w2(s, `${p}:data`) : (0, import_react7.useState)(s), [f2, e] = p ? w2({}, `${p}:errors`) : (0, import_react7.useState)({}), [i, r] = (0, import_react7.useState)(false), [y, T] = (0, import_react7.useState)(false), [H2, F] = (0, import_react7.useState)(null), [M2, b] = (0, import_react7.useState)(false), [O2, x] = (0, import_react7.useState)(false), I2 = (t) => t;
  ...
  let h = (0, import_react7.useCallback)((t, o, n = {}) => {
    let C2 = { ...n, onCancelToken: (m) => {
      ...
      if (a.current && (T(false), F(null), e({}), r(false), b(true), x(true), P.current = setTimeout(() => {
        a.current && x(false);
      }, 2e3)), n.onSuccess)
        return n.onSuccess(m);
    }, onError: (m) => {
      if (a.current && (T(false), F(null), e(m), r(true)), n.onError)
        return n.onError(m);
    }, onCancel: () => {
      if (a.current && (T(false), F(null)), n.onCancel)
        return n.onCancel();
    }, onFinish: () => {
      if (a.current && (T(false), F(null)), d.current = null, n.onFinish)
        return n.onFinish();
    } };
  ...
  }, isDirty: !(0, import_lodash.default)(u2, s), errors: f2, hasErrors: i, processing: y, progress: H2, wasSuccessful: M2, recentlySuccessful: O2, transform(t) {
    I2 = t;
  }, setDefaults(t, o) {
    S2(typeof t > "u" ? () => u2 : (n) => ({ ...n, ...typeof t == "string" ? { [t]: o } : t }));
  }, reset(...t) {
    t.length === 0 ? g(s) : g(Object.keys(s).filter((o) => t.includes(o)).reduce((o, n) => (o[n] = s[n], o), { ...u2 }));
  }, setError(t, o) {
    e((n) => {
